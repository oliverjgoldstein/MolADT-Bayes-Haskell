...
This repo does not ship precomputed benchmark results. The comparison figures are generated by real non-dry runs from the sibling Python repo, and `results/` is meant to be populated only by those local runs.

Run in the Python repo:
