...
molecule = either error id (validateMolecule (Molecule
  { atoms = M.fromList
      ...
      , (AtomId 10, Atom { atomID = AtomId 10, attributes = elementAttributes Cl, coordinate = Coordinate (mkAngstrom (-1.0219099764656379)) (mkAngstrom (-2.721909976465638)) (mkAngstrom 1.0219099764656379), shells = elementShells Cl, formalCharge = 0 })
      , (AtomId 11, Atom { atomID = AtomId 11, attributes = elementAttributes H, coordinate = Coordinate (mkAngstrom 0.0) (mkAngstrom 0.0) (mkAngstrom 1.09), shells = elementShells H, formalCharge = 0 })
