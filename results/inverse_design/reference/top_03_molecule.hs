...
predictedFreeSolv = -4.988867937379672

predictiveSd :: Double
predictiveSd = 0.7736155633275252

targetError :: Double
targetError = 1.1132062620328398e-2

score :: Double
score = -0.23456567678834317
...
molecule = either error id (validateMolecule (Molecule
  { atoms = M.fromList
      ...
      , (AtomId 10, Atom { atomID = AtomId 10, attributes = elementAttributes Cl, coordinate = Coordinate (mkAngstrom (-1.0219099764656379)) (mkAngstrom (-2.721909976465638)) (mkAngstrom 1.0219099764656379), shells = defaultShells (elementAttributes Cl), formalCharge = 0 })
      , (AtomId 11, Atom { atomID = AtomId 11, attributes = elementAttributes H, coordinate = Coordinate (mkAngstrom 0.0) (mkAngstrom 0.0) (mkAngstrom 1.09), shells = defaultShells (elementAttributes H), formalCharge = 0 })
  ...
  , systems =
      ...
      , (SystemId 10, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 2) (AtomId 10)]) Just ("single"))
      , (SystemId 11, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 1) (AtomId 11)]) Just ("single"))
      , (SystemId 12, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 2) (AtomId 12)]) Just ("single"))
      , (SystemId 13, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 7) (AtomId 13)]) Just ("single"))
      , (SystemId 14, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 9) (AtomId 14)]) Just ("single"))
      , (SystemId 15, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 9) (AtomId 15)]) Just ("single"))
      , (SystemId 16, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 9) (AtomId 16)]) Just ("single"))
      ]
