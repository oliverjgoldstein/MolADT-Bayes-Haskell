...
molecule = either error id (validateMolecule (Molecule
  { atoms = M.fromList
      ...
      , (AtomId 4, Atom { atomID = AtomId 4, attributes = elementAttributes Cl, coordinate = Coordinate (mkAngstrom 0.0) (mkAngstrom (-1.43)) (mkAngstrom 0.0), shells = defaultShells (elementAttributes Cl), formalCharge = 0 })
      ...
      , (AtomId 6, Atom { atomID = AtomId 6, attributes = elementAttributes H, coordinate = Coordinate (mkAngstrom 1.09) (mkAngstrom 1.48) (mkAngstrom 0.0), shells = defaultShells (elementAttributes H), formalCharge = 0 })
      ...
      , (AtomId 8, Atom { atomID = AtomId 8, attributes = elementAttributes H, coordinate = Coordinate (mkAngstrom 0.0) (mkAngstrom 5.3999999999999995) (mkAngstrom 0.0), shells = defaultShells (elementAttributes H), formalCharge = 0 })
      ]
