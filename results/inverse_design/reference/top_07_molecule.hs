...
molecule = either error id (validateMolecule (Molecule
  { atoms = M.fromList
      ...
      , (AtomId 4, Atom { atomID = AtomId 4, attributes = elementAttributes C, coordinate = Coordinate (mkAngstrom 0.0) (mkAngstrom (-1.7)) (mkAngstrom (-1.43)), shells = elementShells C, formalCharge = 0 })
      ...
      , (AtomId 11, Atom { atomID = AtomId 11, attributes = elementAttributes H, coordinate = Coordinate (mkAngstrom 0.7707463914933368) (mkAngstrom (-1.7)) (mkAngstrom 0.7707463914933368), shells = elementShells H, formalCharge = 0 })
      ...
      , (AtomId 14, Atom { atomID = AtomId 14, attributes = elementAttributes H, coordinate = Coordinate (mkAngstrom 0.0) (mkAngstrom 3.92) (mkAngstrom 0.0), shells = elementShells H, formalCharge = 0 })
      ]
