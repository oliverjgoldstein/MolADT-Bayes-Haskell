...
predictedFreeSolv = -4.622151045762554

predictiveSd :: Double
predictiveSd = 0.7172489868490254

targetError :: Double
targetError = 0.3778489542374457

score :: Double
score = -0.25466087342956134
...
molecule = either error id (validateMolecule (Molecule
  { atoms = M.fromList
      ...
      , (AtomId 4, Atom { atomID = AtomId 4, attributes = elementAttributes C, coordinate = Coordinate (mkAngstrom 0.0) (mkAngstrom (-1.7)) (mkAngstrom (-1.43)), shells = defaultShells (elementAttributes C), formalCharge = 0 })
      ...
      , (AtomId 11, Atom { atomID = AtomId 11, attributes = elementAttributes H, coordinate = Coordinate (mkAngstrom 0.7707463914933368) (mkAngstrom (-1.7)) (mkAngstrom 0.7707463914933368), shells = defaultShells (elementAttributes H), formalCharge = 0 })
      ...
      , (AtomId 14, Atom { atomID = AtomId 14, attributes = elementAttributes H, coordinate = Coordinate (mkAngstrom 0.0) (mkAngstrom 3.92) (mkAngstrom 0.0), shells = defaultShells (elementAttributes H), formalCharge = 0 })
      ]
  ...
  , systems =
      ...
      , (SystemId 11, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 4) (AtomId 12)]) Just ("single"))
      , (SystemId 12, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 4) (AtomId 13)]) Just ("single"))
      , (SystemId 13, mkBondingSystem (NonNegative 2) (S.fromList [Edge (AtomId 7) (AtomId 14)]) Just ("single"))
      ]
